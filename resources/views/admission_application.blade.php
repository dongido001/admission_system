							  ...
							  <div class="form-group">
							    <label for="faculty">Desired course of study</label>
					             <select class="form-control" id="exampleSelect1" name="course">
									...
									<option>Agricultural and Bio-Resources Engineering</option>
									<option>Agricultural Economics</option>
									<option>Agricultural Extension Services</option>
									<option>Agricultural Science and Education</option>
									<option>Agriculture</option>
									<option>Animal Science</option>
									<option>Archaeology</option>
									<option>Architecture</option>
									<option>Arts (Combined Honours)</option>
									<option>Banking and Finance (Admin)</option>
									<option>Biochemistry</option>
									<option>Biological Science(s)</option>
									<option>Botany</option>
									<option>Business Education</option>
									<option>Civil Engineering</option>
									<option>Computer Education</option>
									<option>Computer Science</option>
									<option>Computer with Statistics</option>
									...
									<option>Industrial Technical Education</option>
									<option>Law</option>
									<option>Library and Information Science</option>
									<option>Linguistics</option>
									<option>Linguistics, Igbo and other African Languages</option>
									<option>Marketing</option>
									<option>Mass Communication</option>
									<option>Mathematics
									<option>Mechanical Engineering</option>
									<option>Medical Laboratory Technology / Science</option>
									...
									<option>Physics / Astrology</option>
									<option>Political Science</option>
									<option>Psychology</option>
									<option>Public Administration</option>
									<option>Public Administration</option>
									<option>Public Administration And Local Government</option>
									<option>Public Relations and Advertising</option>
									<option>Pure / Applied Chemistry</option>
									<option>Pure and Industrial Chemistry</option>
									...
									<option>Surveying and Geo-Informatics</option>
